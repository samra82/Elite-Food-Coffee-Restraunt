    ...
    <div className="min-h-screen bg-white">
     ...
     <div className="h-[300px] md:h-[400px] lg:h-[500px] bg-cover bg-center relative">
       ...
       <div className="absolute inset-0 flex flex-col justify-center items-center text-white text-center px-4">
         <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold">Sign up page</h1>
        ...
        <div className="container mx-auto max-w-md bg-white shadow-lg rounded-md p-8">
          ...
          <div className="text-center mt-8">
            ...
            <button className="w-full bg-gray-100 border text-black py-2 rounded mt-2 flex items-center justify-center">
              <Image width={24} height={24}  src="/assets/Google.svg" alt="Google" className="h-6 mr-2" />
              Sign up with Google
            </button>
            <button className="w-full bg-gray-100 border text-black py-2 rounded mt-2 flex items-center justify-center">
              <Image  width={24} height={24} src="/assets/Apple.svg" alt="Apple" className="h-6 mr-2" />
              Sign up with Apple
            </button>
          </div>
        </div>
